...
{
    public static string OnlyLettersSpacesAndDashes = "Поле {PropertyName} должно содержать только буквы, пробелы и дефисы.";
    public static string OnlyLettersDigitsSpacesAndDashes = "Поле {PropertyName} должно содержать только буквы, цифры и дефисы.";
    ...
    public static string InvalidEmail = "{PropertyName} не валиден";
